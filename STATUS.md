...
> 本檔由 `check.py` 產生於 2026-09-05 06:43:47 UTC，不手寫。每次執行都重跑驗證，不沿用上次結論。
...
| 項目 | 結果 | 說明 |
|---|---|---|
| SatNOGS 全球地面站幾何比對 | ✅ PASS | 25 站；升起方位平均差 0.30°、最大仰角平均差 0.25°（SatNOGS 只報整數度，捨入即 ±0.5°） |
| 都卜勒 vs Skyfield 獨立實作 | ✅ PASS | 擺幅 20,751 Hz；最大差 0.21 Hz（10.0 ppm） |
